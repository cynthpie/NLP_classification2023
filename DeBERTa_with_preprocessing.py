...
# preprocess data to remove stop words, punctuation and make lowercase
...
# save the model
trainer.save_model(f"./models/saved_model_preprocessing/")

############

# load the model
model = DebertaForSequenceClassification.from_pretrained(f"./models/saved_model_preprocessing/")
model.to(device)
...
with open(f"val_eval_with_preprocessing.txt", "w") as file:
