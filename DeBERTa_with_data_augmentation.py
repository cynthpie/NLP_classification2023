...
# save the model
trainer.save_model(f"./models/saved_model_data_augmentation/")

############

# load the model
model = DebertaForSequenceClassification.from_pretrained(f"./models/saved_model_data_augmentation/")
model.to(device)
...
with open(f"val_eval_with_data_augmentation.txt", "w") as file:
